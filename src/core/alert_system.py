...
class AlertSystem:
    ...
    def render_drowsiness_alert(self, frame, duration=None):
        ...
        if duration:
            cv2.putText(frame, f"Sleep time: {duration}s", (20, 150), cv2.FONT_HERSHEY_SIMPLEX, 0.7, self.config.ALERT_COLOR, 2)
        return frame
    ...
    def render_metrics(self, frame, metrics, status_text):
        # Hiển thị thông tin trạng thái và số liệu
